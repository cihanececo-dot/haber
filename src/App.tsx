      ...
      <div className="w-full md:w-3/5 min-h-screen border-r border-slate-200 z-10 px-6 md:px-16 lg:px-24">
        ...
        <div className="pb-32">
          ...
          <Step id="adalet" index={2} activeStep={activeStep} onStepEnter={setActiveStep}>
            ...
            <img src="https://picsum.photos/seed/adalet/800/400?grayscale" alt="Tedbir Kararları" className="w-full object-cover aspect-video mb-8 opacity-80 mix-blend-multiply contrast-125 brightness-90 border border-slate-200 pointer-events-none" />
            <div className="space-y-6 text-slate-600 text-lg md:text-xl leading-relaxed">
              <p>
          ...
          <Step id="ahlaki" index={4} activeStep={activeStep} onStepEnter={setActiveStep}>
            ...
            <img src="https://picsum.photos/seed/ahlak/800/400?grayscale" alt="Ahlaki Çözülme" className="w-full object-cover aspect-video mb-8 opacity-80 mix-blend-multiply contrast-125 brightness-90 border border-slate-200 pointer-events-none" />
            <div className="space-y-6 text-slate-600 text-lg md:text-xl leading-relaxed">
              <p>
